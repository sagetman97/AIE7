    ...
    async with httpx.AsyncClient(timeout=httpx.Timeout(60.0)) as httpx_client:
        ...
        send_message_payload: dict[str, Any] = {
            'message': {
                'role': 'user',
                'parts': [
                    {'kind': 'text', 'text': 'What are the key differences between term life insurance and whole life insurance?'}
                ],
        ...
        send_message_payload_multiturn: dict[str, Any] = {
            'message': {
                ...
                'parts': [
                    {
                        'kind': 'text',
                        'text': 'Explain the DIME method for calculating life insurance needs and when it would be most appropriate to use.',
                    }
                ],
                'message_id': uuid4().hex,
            },
        ...
        second_send_message_payload_multiturn: dict[str, Any] = {
            'message': {
                'role': 'user',
                'parts': [{'kind': 'text', 'text': 'What are the advantages and disadvantages of the capital needs analysis approach compared to the DIME method?'}],
                'message_id': uuid4().hex,
                'task_id': task_id,
